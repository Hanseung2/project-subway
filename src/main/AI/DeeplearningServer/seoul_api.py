...
class seoulAPI():
    ...
    def staion_arrive_info(self):
        ...
        return self.parsing_xml(xml_data)
    ...
    def call_api(self):
        ...
        # API 엔드포인트 URL
        api_url = f"http://swopenAPI.seoul.go.kr/api/subway/{api_key}/xml/realtimeStationArrival/0/1000/"

        # 사용자 입력으로부터 역 이름 받기
        # station_name = input("검색할 역 이름을 입력하세요: ")

        # API 호출을 위한 요청 URL 생성
        request_url = api_url + self.station_name
